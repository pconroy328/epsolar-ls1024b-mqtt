...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ls1024b_mqtt: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ls1024b_mqtt ${OBJECTFILES} ${LDLIBSOPTIONS} -lsccls10x4b -lcjson

${OBJECTDIR}/commandQueue.o: commandQueue.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/commandQueue.o commandQueue.c

${OBJECTDIR}/doCommand.o: doCommand.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/doCommand.o doCommand.c

${OBJECTDIR}/jsonMessage.o: jsonMessage.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMessage.o jsonMessage.c
